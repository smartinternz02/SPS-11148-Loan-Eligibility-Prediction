...
public class LogRegression {
	...
	public static void main(String args[]) {
		...
		try {
			Table bank_data = Table.read().csv("C:\\Users\\manideep\\Downloads\\train.csv");
			...
			Instances train_data = getInstances("C:\\Users\\manideep\\Downloads\\train.csv.arff");
			Instances test_data = getInstances("C:\\Users\\manideep\\Downloads\\test.csv.arff");
